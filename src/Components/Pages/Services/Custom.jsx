            ...
            <div className="grow pt-0.5 pb-8 sm:pb-12">
              <p className="text-sm lg:text-base text-neutral-400">
                <span className="text-white">
                  Tailer made Software 
                </span>
                Right UpNext Pvt. Ltd. provides ventures with top-notch
                 corporate software. Business activities can be effectively categorized with the use of enterprise software. We provide tailored solutions to improve daily activities and processes. As an Indian corporate software development company, we create software to improve organizational effectiveness, boost worker productivity, and calibrate resources. It also 
                oversees departmental communication, which fosters a positive environment.
              </p>
            </div>
            {/* End Right Content */}
          </div>
          ...
          <div className="flex gap-x-5 ms-1">
            ...
            <div className="grow pt-0.5 pb-8 sm:pb-12">
              <p className="text-sm lg:text-base text-neutral-400">
                ...
                We specialize in delivering outstanding ERP software that efficiently manages all aspects of enterprise performance, including accounting, group activities, procurement, projects, and supply chain operations. Additionally, we provide advanced CRM solutions powered by cutting-edge technology to enhance interactions between organizations and their customers, 
          ...
          <div className="flex gap-x-5 ms-1">
            ...
            <div className="grow pt-0.5 pb-8 sm:pb-12">
              <p className="text-sm md:text-base text-neutral-400">
                ...
                ultimately improving business relationships and driving greater benefits.
              </p>
            </div>
            {/* End Right Content */}
          </div>
