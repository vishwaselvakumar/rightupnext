  ...
  <div className="bg-neutral-900 mt-20">
    ...
    <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20 lg:pb-20 mx-auto">
      ...
      <div className="max-w-3xl mb-10 lg:mb-14">
        ...
        The competition in the global marketplace has intensified, compelling both start-ups and 
        established companies to establish a strong online
         presence.
        </p>
      </div>
      {/* End Title */}
          ...
          <div className="flex gap-x-5 ms-1">
            ...
            <div className="grow pt-0.5 pb-8 sm:pb-12">
              <p className="text-sm lg:text-base text-neutral-400">
                ...
                We offer web application development services that
                 use cutting-edge technology to get the required results and suit the expectations 
                of our clients. We are focused on developing user-friendly online apps.
              </p>
            </div>
            {/* End Right Content */}
          </div>
          ...
          <div className="flex gap-x-5 ms-1">
            ...
            <div className="grow pt-0.5 pb-8 sm:pb-12">
              <p className="text-sm md:text-base text-neutral-400">
                <span className="text-white">Cloud-based solutions</span><br/>
                We render cloud-based solutions to reach a reliable cloud infrastructure and 
                progressive management with flexibility.
                 We promise secured, compatible, and accessible solutions for your business growth.
              </p>
            </div>
            {/* End Right Content */}
          </div>
          ...
          <div className="flex gap-x-5 ms-1">
            ...
            <div className="grow pt-0.5 pb-8 sm:pb-12">
              <p className="text-sm md:text-base text-neutral-400">
                ...
                We provide comprehensive management and analysis services. We assist companies with 
                field fear by providing useful insights and protecting data assets.
              </p>
            </div>
            {/* End Right Content */}
          </div>
