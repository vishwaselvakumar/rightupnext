...
{/* About */}
      ...
      <section className="px-10 overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] bg-white dark:bg-dark">
          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <h2 className="mb-5 text-sm font-bold text-dark  sm:text-[40px]/[48px]">
                  Make your customers happy by giving services.
                </h2>
                <p className="mb-5 text-base text-body-color dark:text-dark-6">
                We serve extensive IT solutions, including website design
                 and development, mobile application development, software 
                 development, graphic design, digital marketing, animation, 
                 and video creation, to meet your business needs.
                </p>
                <p className="font-bold">About Company</p>
                <p className="mb-8 text-base text-body-color dark:text-dark-6">
                We evolved into Right UpNext Innovations in 2024 to reflect our commitment to staying ahead in the ever-changing digital landscape. Our name embodies our focus on innovation
                , agility, and delivering cutting-edge solutions that prepare 
                businesses for what's next.
                </p>

                <p className="font-bold">Mission 
                </p>
                <p className="mb-8 text-base text-body-color dark:text-dark-6">
                Our mission is to drive success through innovation, adaptability, and reliable partnerships. We invest in people and technology to meet evolving needs. Staying ahead, we help businesses stay competitive.
Vision<br/>
We empower businesses of all sizes with tailored solutions, from web design to mobile development, enabling innovation and growth. We deliver high-performing agile solutions aligned with your technology roadmap by evolving skills, practices, and team cultures.

                </p>

                <a
                  href="https://wa.me/9123509552" target='_blank'
                  className="inline-flex items-center justify-center py-3 text-base font-medium text-center  border border-blue rounded-md px-7 bg-blue hover:bg-opacity-90"
                >
                  Get Started
                </a>
              </div>
