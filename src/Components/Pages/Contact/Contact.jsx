...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const whatsappNumber = "6385557221"; // Replace with your WhatsApp number
    const whatsappURL = `https://wa.me/${whatsappNumber}?text=${encodeURIComponent(
      `Name: ${name}\nEmail: ${email}\nPhone: ${phone}\nMessage: ${message}`
    )}`;

    // Redirect to WhatsApp
    window.location.href = whatsappURL; // Direct navigation to the WhatsApp app
  };
              ...
              <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                <div class="mb-12 max-w-[570px] lg:mb-0 pl-4">
                  ...
                  Join us on our journey as a leading IT and digital company,
                   transforming ideas into innovative solutions that
                ...
                <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                  {/* <form>
                    ...
                    <div>
                      <button
                        type="submit"
                        class="bg-black border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                      >
                        Send Message
                      </button>
                    </div>
