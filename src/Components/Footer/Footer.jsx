...
<footer class="bg-blue-200 py-8 px-8 font-[sans-serif] tracking-wide mt-16">
      <div class="relative max-w-screen-xl mx-auto">
        <div class="bg-blue-600 gap-3 rounded-md flex flex-wrap items-center justify-between sm:px-8 max-sm:px-4 py-4 absolute top-[-66px] w-full">
          ...
          <a href="/contact">
          <button type='button'
            class="px-4 py-2 text-sm rounded-full text-blue-600 gap-2 bg-white">Get
            Started</button>
            </a>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pt-10">
          <div class="lg:col-span-2 max-w-md">
            {/* <h4 class="text-lg font-semibold mb-6 text-black">About Us</h4> */}
            <div className='mb-8'>
    ...
    +91 9159260221
          ...
          <div>
            ...
            <ul class="flex flex-wrap gap-4">
              ...
              <li>
                <a href='https://www.linkedin.com/company/right-upnext-innovations/?lipi=urn%3Ali%3Apage%3Ad_flagship3_company%3Bp4gCZfoGThSADoDJOJ1I1g%3D%3D' target='_blank'>
      ...
      <div class="bg-gray-900 py-4 px-4 -mx-8 text-center mt-10">
        <p class='text-white text-base'>&copy; {new Date().getFullYear()} Right UpNext Innovations</p>
      </div>
    </footer>
...
{/* <footer class="bg-[#0b0e37] py-12 px-6 font-sans tracking-wide">
      <div class="flex flex-col items-center gap-6">
        ...
        <ul class="flex flex-wrap justify-center gap-x-7 gap-4">
          <li><a href="javascript:void(0)" class="text-xl hover:text-white">
        ...
        <ul class="flex flex-wrap gap-x-7 gap-4">
          <li><a href=" " class="hover:underline text-black text-base transition-all">Terms of Service</a></li>
          <li><a href=" " class="hover:underline text-black text-base transition-all">Privacy Policy</a></li>
          <li><a href=" " class="hover:underline text-black text-base transition-all">Contact</a></li>
        </ul>
      </div>
    </footer> */}
   </>
